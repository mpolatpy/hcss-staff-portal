...
export const selectTeacherList = createSelector(
    [selectTeachers, selectActiveTeacherPreference],
    (teachers, activeTeacherPreference) => {
        if (!teachers) return [];
        ...
        if(activeTeacherPreference){
            teacherList = teacherList.filter(teacher => teacher.isActive);
        }
